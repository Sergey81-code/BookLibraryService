...
Revision ID: 40032e55006b
Revises: 
Create Date: 2025-03-02 11:20:52.353918
...
def upgrade() -> None:
    ...
    op.execute("DROP TYPE IF EXISTS book_statuses_enum")
    op.execute("DROP TYPE IF EXISTS book_conditions_enum")
